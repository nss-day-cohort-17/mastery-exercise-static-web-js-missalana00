...
the tree should be shown in the console. This requires you to add an event listener to the button,
...
the button, then display an alert stating that both fields must have a value.
